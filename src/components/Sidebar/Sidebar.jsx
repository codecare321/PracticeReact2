    ...
    <div className="absolute left-0 top-0 p-4 flex overflow-y-hidden flex-col h-screen w-72.5 bg-black lg:static ">
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto">
        <nav className="mt-5 py-4  lg:mt-9 lg:px-6">
          <div className="">
            <h3 className="mb-4 ml-2 text-sm font-semibold text-gray-200">
              MENU
            </h3>

            <ul>
              <li>
                <a className="group relative flex items-center gap-2.5 text-white">
                  <svg
          ...
          <div>
            <h3 className="mb-4 mt-6 text-sm font-semibold text-white">
              OTHERS
            </h3>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  onClick={logout}
                  className="text-white group relative flex items-center gap-2.5 rounded-sm py-2 font-medium duration-300 ease-in-out"
                >
                  <svg
                    className="fill-current text-white"
                    width="18"
                  ...
                  >
                    <path
                      d="M10 2H3C2.44772 2 2 2.44772 2 3V21C2 21.5523 2.44772 22 3 22H10C10.5523 22 11 21.5523 11 21V16H13V21C13 21.5523 13.4477 22 14 22H21C21.5523 22 22 21.5523 22 21V3C22 2.44772 21.5523 2 21 2H14C13.4477 2 13 2.44772 13 3V8H11V3C11 2.44772 10.5523 2 10 2ZM12 16V8H14V16H12Z"
                      fill="currentColor"
                    />
                  </svg>
                  LogOut
